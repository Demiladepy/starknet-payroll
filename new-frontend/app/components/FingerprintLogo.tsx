...
export function FingerprintLogo({
  ...
  // Fingerprint arcs — concentric ridges centered at (50,50)
  const paths = [
    // Core — tight center swirl
    "M50 50c0-6.6 5.4-12 12-12",
    "M50 50c0 6.6-5.4 12-12 12",
    // Inner ridges
    "M50 56c0-10 8.1-18 18-18",
    "M50 56c0 10-8.1 18-18 18",
    "M50 44c0 10-8.1 18-18 18",
    "M50 44c0-10 8.1-18 18-18",
    // Mid ridges
    "M50 62c0-14.4 11.6-26 26-26",
    "M50 62c0 13.3-10.7 24-24 24",
    "M50 38c0 14.4-11.6 26-26 26",
    "M50 38c0-13.3 10.7-24 24-24",
    // Outer ridges
    "M50 68c0-19.3 15.7-35 35-35",
    "M50 68c0 16.6-13.4 30-30 30",
    "M50 32c0 19.3-15.7 35-35 35",
    "M50 32c0-16.6 13.4-30 30-30",
    // Outermost ridges
    "M50 74c0-23.2 18.8-42 42-42",
    "M50 74c0 20-16.1 36-36 36",
    "M50 26c0 23.2-18.8 42-42 42",
    "M50 26c0-20 16.1-36 36-36",
  ];
